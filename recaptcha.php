...
// Upload attachment file
    $fileLocation = ""; // Initialize with an empty string

    if (!empty($_FILES['myResume']['name'])) {
    ...
    if ($captchaResponse['success'] == '1' && $captchaResponse['action'] == $action && $captchaResponse['score'] >= 0.1 && $captchaResponse['hostname'] == $_SERVER['SERVER_NAME']) {
